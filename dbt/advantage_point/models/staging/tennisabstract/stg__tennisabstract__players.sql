...
renamed as (
    select
        ...
        {{ remove_empty_string_from_source('atp_id') }} as atp_id,
        {{ remove_empty_string_from_source('photog_link') }} as photog_link,
        {{ remove_empty_string_from_source('fullname') }} as fullname,
        ...
        {{ remove_empty_string_from_source('hand') }} as hand,
        {{ convert_rank_to_integer('currentrank') }} as currentrank,
        {{ remove_empty_string_from_source('country') }} as country,
        {{ remove_empty_string_from_source('backhand') }} as backhand,
